...
const RecipeDetails = ({ recipeDetails }: { recipeDetails: string }) => {
    ...
    useEffect(() => {
        ...
        axiosPublic.get('/allRecipes').then((res) => {
            ...
            const filteredRecipe = allRecipes?.find((item: any) => item?._id === recipeDetails)
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <div className="flex justify-end mt-1">
                                    <button onClick={() => router.back()} className="font-sourGummy text-lg underline flex items-center gap-1"><BiLeftArrow /> Go back</button>
                                </div>
                            </div>
                        </div>
                        {/* divider */}
                            ...
                            <div className="text-2xl gap-10 flex justify-end">
                                ...
                                <div>
                                    <button
                                        ...
                                        onClick={() => recipeData && setActiveModal(recipeData._id as string)}
                                    >
                                        <FaStar className="text-primary-orange" />
                                    </button>
                                    <p className="text-base text-center mt-1 font-semibold">
                                        {recipeData && recipeData.ratingsData && recipeData.ratingsData.length > 0
                                            ? (
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`border border-dark-green p-2 rounded-full ${recipeData?.upvote.find(
                                            (email) =>
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`border border-dark-green p-2 rounded-full ${recipeData?.downvote.find(
                                            (email) =>
                                                email.email === user?.email &&
                                                email.downvote === true
                                        )
                                ...
                                <div>
                                    ...
                                    <dialog
                                        // id={`${item.email}`} 
                                        open={!!recipeData && activeCommentsModal === recipeData.email}
                                        className="modal">
                                        <div className="modal-box">
                                            <h3 className="font-bold text-lg">
                                                    ...
                                                    <div key={index} className="mt-2 flex items-center justify-between" >
                                                        ...
                                                        <div>
                                                            {findUser?.email === comment.email && <div className="pr-5 text-xl flex items-center gap-4">
                                                                ...
                                                                <button className=" p-1 rounded-md shadow-md bg-white"
                                                                onClick={() => handleDeleteComment(recipeData._id as string, comment._id)}
                                                                ><RiDeleteBin4Fill className="text-red-600" /></button>
                                                                ...
                                                                <dialog
                                                                    ...
                                                                    <div className="modal-box">
                                                                        ...
                                                                        <div className="modal-action">
                                                                            <form
                                                                                onSubmit={(e) =>
                                                  handleCommentUpdate(recipeData?._id as string, e, comment._id)
                                                }
                                                                                //   method="dialog"
                                                                                className="w-full"
                                                                            >
